      ...
      <View style={{ flex: 1 }}>
        <View style={styles.tabs()}>
          <TouchableOpacity
            style={[
              styles.tab(),
              tab == 0 && styles.selectedTab(),
              Platform.OS == 'ios' && styles.borderRight
            ]}
            onPress={this.changeTab.bind(null, 0)}
          >
            <Text style={[styles.tabText(), tab == 0 && styles.selectedText()]}>
              All
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text style={[styles.tabText(), tab == 1 && styles.selectedText()]}>
              Favorites
            </Text>
          </TouchableOpacity>
        </View>
